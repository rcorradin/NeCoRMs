...
writeLines(c(""), "output_200_high.txt")
out_list_200_high <- list()
...
for(i in 1:nrep){
  ...
  cat(paste("completed: ", rep / 100, "%\n"), file = "output_200_high.txt", append = TRUE)
  out_list_200_high[[i]] <- res
}
save.image(file = "simu_compound_200_high.Rdata")
