...
writeLines(c(""), "output_200_low.txt")
out_list_200_low <- list()
...
for(i in 1:nrep){
  ...
  cat(paste("completed: ", rep / 100, "%\n"), file = "output_200_low.txt", append = TRUE)
  out_list_200_low[[i]] <- res
}
save.image(file = "simu_compound_200_low.Rdata")
