...
dgp1 <- function(n, t){
  means_temp <- c(sample(c(0, 3, 6) / t, size = n, prob = c(0.5, 0.25, 0.25), replace = TRUE),
                  sample(c(0, 3, 6) / t, size = n, prob = c(0.5, 0.25, 0.25), replace = TRUE),
                  sample(c(0, 3, 6) / t, size = n, prob = c(0.5, 0.25, 0.25), replace = TRUE),
                  sample(c(0, 3, 6) / t, size = n, prob = c(0.5, 0.25, 0.25), replace = TRUE),
                  sample(c(0, 3, 6) / t, size = n, prob = c(0.5, 0.25, 0.25), replace = TRUE),
                  sample(c(0, 3, 6) / t, size = n, prob = c(0.5, 0.25, 0.25), replace = TRUE))
...
true_dens <- function(grid, t){
  rbind(
    0.5 * dnorm(grid, 0 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 3 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 6 / t, sqrt(0.6)),
    0.5 * dnorm(grid, 0 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 3 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 6 / t, sqrt(0.6)),
    0.5 * dnorm(grid, 0 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 3 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 6 / t, sqrt(0.6)),
    0.5 * dnorm(grid, 0 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 3 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 6 / t, sqrt(0.6)),
    0.5 * dnorm(grid, 0 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 3 / t, sqrt(0.6)) + 0.25 * dnorm(grid, 6 / t, sqrt(0.6)),
